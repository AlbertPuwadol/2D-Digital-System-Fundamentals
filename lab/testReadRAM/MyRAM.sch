...
<drawing version="7">
    ...
    <netlist>
        ...
        <port polarity="Input" name="in(0:3)" />
        ...
        <block symbolname="ram16x4s" name="XLXI_22">
            ...
            <blockpin signalname="in(0)" name="D0" />
            <blockpin signalname="in(1)" name="D1" />
            <blockpin signalname="in(2)" name="D2" />
            <blockpin signalname="in(3)" name="D3" />
    ...
    <sheet sheetnum="1" width="3520" height="2720">
        ...
        <iomarker fontsize="28" x="464" y="912" name="in(0:3)" orien="R180" />
    </sheet>
</drawing>